...
$result1=FALSE;  # [Update]
$result2=FALSE; # [Update]
...
try{
	...
	if($_POST['first']!=null && $_POST['last']!=null && $_POST['email']!=null)
	{
		...
		if(validSubmission($first,$last,$email))
			$result1 = insertInfo($db1,$first,$last,$email); # [Update]
	}
...
try{
	...
	if($_POST['first']!=null && $_POST['last']!=null && $_POST['email']!=null)
	{
		...
		$email=filter_var(trim($_POST['email']),FILTER_SANITIZE_EMAIL);
		if(validSubmission($first,$last,$email))
			$result2 = insertInfo($db2,$first,$last,$email); # [Update]
	}
